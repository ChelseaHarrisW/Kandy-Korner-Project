...
import { getProductByLocationId, PostNewPurchase } from "../API-Manager"
...
export const Location = () => {
    ...
    return (
        ...
        {productLocations.map((productLocation) => {
            return (
            <section key={`product--${productLocation.product.id}`} className="product">
                <div className="product__info">
                    <div className="product__name">{productLocation.product.name}</div>
                    <div className="product__type">Type:{productLocation.product.type} </div>
                ...
                <button className="purchase-btn"
                    ...
                    }}><span> 🍬🍭🍫Purchase this candy 🍫🍭🍬</span></button>
            </section>
            )}
            )}
            </>
